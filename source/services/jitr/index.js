...
exports.handler = function(event, context, callback) {
    ...
    var policy = {
        ...
        "Statement": [{
            ...
            "Resource": `arn:aws-cn:iot:${region}:${accountId}:client/` +
            ...
            "Resource": [
                `arn:aws-cn:iot:${region}:${accountId}:topic/${telemetricsTopic}/` +
                '${iot:Certificate.Subject.Pseudonym}',
                `arn:aws-cn:iot:${region}:${accountId}:topic/${aggregationTopic}/` +
                '${iot:Certificate.Subject.Pseudonym}',
                `arn:aws-cn:iot:${region}:${accountId}:topic/${dtcTopic}/` +
                '${iot:Certificate.Subject.Pseudonym}',
                `arn:aws-cn:iot:${region}:${accountId}:topic/${alertTopic}/` +
                '${iot:Certificate.Subject.Pseudonym}/*'
            ]
        }, {
            "Effect": "Allow",
            ...
            "Resource": [
                `arn:aws-cn:iot:${region}:${accountId}:topicfilter/${telemetricsTopic}/` +
                '${iot:Certificate.Subject.Pseudonym}',
                `arn:aws-cn:iot:${region}:${accountId}:topicfilter/${dtcTopic}/` +
                '${iot:Certificate.Subject.Pseudonym}',
                `arn:aws-cn:iot:${region}:${accountId}:topicfilter/${alertTopic}/` +
                '${iot:Certificate.Subject.Pseudonym}/*'
            ]
        }]
    };
